...
let test_vec cmp eq ne lt gt le ge vec =
  ...
  ( (map gen_cmp vec, map cmp vec),
    map
      (fun gen spec -> (map gen vec, map spec vec))
      [
        (gen_eq, eq);
        (gen_ne, ne);
        (gen_lt, lt);
...
test_vec string_cmp string_eq string_ne string_lt string_gt string_le string_ge
  string_vec
;;
...
eta_test_vec eta_int_cmp eta_int_eq eta_int_ne eta_int_lt eta_int_gt eta_int_le
  eta_int_ge int_vec
;;
...
eta_test_vec eta_float_cmp eta_float_eq eta_float_ne eta_float_lt eta_float_gt
...
eta_test_vec eta_int32_cmp eta_int32_eq eta_int32_ne eta_int32_lt eta_int32_gt
  eta_int32_le eta_int32_ge int32_vec
;;

eta_test_vec eta_int64_cmp eta_int64_eq eta_int64_ne eta_int64_lt eta_int64_gt
