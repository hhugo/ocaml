...
module type Reject1 = sig module  M := Funct(M) end
...
module type Reject2 = sig module  M := F(N) end
...
module type Reject3 = sig type t := u end
...
module type RejectRec = sig type t := [ `Foo of t | `Nil ] end
