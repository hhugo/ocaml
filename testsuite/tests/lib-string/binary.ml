...
let () =
  ...
  for i = 0 to String.length b - 2 do
    ...
    let f = if Sys.big_endian then String.get_int16_be else String.get_int16_le
    in
    assert (x = f b i);
  ...
  for i = 0 to 0xffff do
    ...
    assert
      ((if Sys.big_endian then String.get_uint16_be else String.get_uint16_le) s
         0 =
         i)
  done;
...
let () =
  ...
  for i = 0 to String.length b - 4 do
    ...
    let f = if Sys.big_endian then String.get_int32_be else String.get_int32_le
    in
    assert (x = f b i)
  done;
...
let () =
  ...
  for i = 0 to String.length b - 8 do
    ...
    let f = if Sys.big_endian then String.get_int64_be else String.get_int64_le
    in
    assert (x = f b i)
  done;
