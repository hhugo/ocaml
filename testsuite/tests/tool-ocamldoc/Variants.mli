...
type u = A (** doc for A *) | B of unit (** doc for B *)

(** With records *)
type w = A of { x : int } (** doc for A *) | B of { y : int } (** doc for B *)

(** With args *)
type z = A of int (** doc for A *) | B of int (** doc for B *)

(** Gadt notation *)
type a = A : a (** doc for A*)
