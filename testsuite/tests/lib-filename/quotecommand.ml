...
let copy_file src dst =
  ...
  let oc =
    open_out_gen [ Open_wronly; Open_creat; Open_trunc; Open_binary ] 0o777 dst
  in
  copy_channels ic oc;
  close_in ic;
  close_out oc
...
let myecho = Filename.concat Filename.current_dir_name "my echo.exe"
