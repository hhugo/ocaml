    ...
    (CProp
       ("equal",
        [ CProp ("eqp", [ CVar 23; CVar 24 ]);
          CProp
            ("equal", [ CProp ("fix", [ CVar 23 ]); CProp ("fix", [ CVar 24 ]) ])
        ]));
  add
    (CProp
       ("equal",
    ...
    (CProp
       ("equal",
        [
          ...
          CProp
            ("and", [ CProp ("zerop", [ CVar 0 ]); CProp ("zerop", [ CVar 1 ]) ])
        ]));
  add
    (CProp
       ("equal",
               ...
               CProp
                 ("big_plus",
                  [ CProp ("power_rep", [ CVar 8; CVar 1 ]);
                    ...
                    CVar 1 ]); CVar 1 ]); CProp ("plus", [ CVar 8; CVar 9 ]) ]));
  add
    (CProp
       ("equal",
          ...
          CProp
            ("difference",
             [ CProp ("plus", [ CVar 1; CProp ("plus", [ CVar 0; CVar 2 ]) ]);
               CVar 0 ]); CProp ("plus", [ CVar 1; CVar 2 ]) ]));
  add
    (CProp
       ("equal",
        [
