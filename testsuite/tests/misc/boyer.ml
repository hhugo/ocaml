...
let _ =
    ...
    (CProp
       ( "equal",
         [
           ...
           CProp
             ( "equal",
               [ CProp ("fix", [ CVar 23 ]); CProp ("fix", [ CVar 24 ]) ] );
         ] ));
  add
    (CProp
       ( "equal",
    ...
    (CProp
       ( "equal",
         [
           ...
           CProp
             ( "cons",
               [ CProp ("cons", [ CVar 21; CProp ("true", []) ]); CVar 0 ] );
         ] ));
  add
    (CProp
       ( "equal",
         [
           ...
           CProp
             ( "cons",
               [ CProp ("cons", [ CVar 21; CProp ("false", []) ]); CVar 0 ] );
         ] ));
  add
    (CProp
       ( "equal",
         [
           ...
           CProp
             ( "tautologyp",
               [ CProp ("normalize", [ CVar 23 ]); CProp ("nil", []) ] );
         ] ));
  add
    (CProp
       ( "equal",
    ...
    (CProp
       ( "equal",
         [
           ...
           CProp
             ( "if",
               [ CProp ("numberp", [ CVar 23 ]); CVar 23; CProp ("zero", []) ]
             );
         ] ));
  add
    (CProp
    ...
    (CProp
       ( "equal",
         [
           CProp
             ( "equal",
               [ CProp ("plus", [ CVar 0; CVar 1 ]); CProp ("zero", []) ] );
           CProp
             ( "and",
               [ CProp ("zerop", [ CVar 0 ]); CProp ("zerop", [ CVar 1 ]) ] );
         ] ));
  add
    (CProp
       ( "equal",
         [ CProp ("difference", [ CVar 23; CVar 23 ]); CProp ("zero", []) ] ));
  add
    (CProp
       ( "equal",
         [
           ...
           CProp
             ("equal", [ CProp ("fix", [ CVar 1 ]); CProp ("fix", [ CVar 2 ]) ]);
         ] ));
  add
    (CProp
       ( "equal",
  ...
  add
    (CProp
       ( "equal",
         [
           CProp
             ("equal", [ CVar 23; CProp ("difference", [ CVar 23; CVar 24 ]) ]);
           CProp
             ( "and",
               [
       ...
       ( "equal",
         [
           CProp
             ( "meaning",
               [
                 CProp ("plus_tree", [ CProp ("plus_fringe", [ CVar 23 ]) ]);
                 CVar 0;
               ] );
    ...
    (CProp
       ( "equal",
         [
           ...
           CProp
             ( "or",
               [ CProp ("zerop", [ CVar 23 ]); CProp ("zerop", [ CVar 24 ]) ] );
         ] ));
  add
    (CProp
       ( "equal",
         [
           CProp
             ( "exec",
               [ CProp ("append", [ CVar 23; CVar 24 ]); CVar 15; CVar 4 ] );
           CProp
             ( "exec",
           ...
           CProp
             ( "plus",
               [
                 ...
                 CProp
                   ( "times",
                     [ CVar 24; CProp ("quotient", [ CVar 23; CVar 24 ]) ] );
               ] );
           CProp ("fix", [ CVar 23 ]);
         ] ));
  add
       ...
       ( "equal",
         [
           CProp
             ( "power_eval",
               [
                 CProp ("big_plus", [ CVar 23; CVar 24; CVar 8; CVar 1 ]);
                 CVar 1;
               ] );
           CProp
             ( "plus",
  ...
  add
    (CProp
       ( "equal",
         [
           CProp ("remainder", [ CVar 24; CProp ("one", []) ]);
           CProp ("zero", []);
         ] ));
  add
    (CProp
  ...
  add
    (CProp
       ( "equal",
         [ CProp ("remainder", [ CVar 23; CVar 23 ]); CProp ("zero", []) ] ));
  add
    (CProp
       ( "equal",
         [
  ...
  add
    (CProp
       ( "equal",
         [
           CProp
             ("power_eval", [ CProp ("power_rep", [ CVar 8; CVar 1 ]); CVar 1 ]);
           CProp ("fix", [ CVar 8 ]);
         ] ));
  add
    (CProp
  ...
  add
    (CProp
       ( "equal",
         [
           CProp ("gcd", [ CVar 23; CVar 24 ]);
           CProp ("gcd", [ CVar 24; CVar 23 ]);
         ] ));
  add
    (CProp
       ( "equal",
  ...
  add
    (CProp
       ( "equal",
         [
           CProp
             ("difference", [ CProp ("plus", [ CVar 23; CVar 24 ]); CVar 23 ]);
           CProp ("fix", [ CVar 24 ]);
         ] ));
  add
    (CProp
       ( "equal",
         [
           CProp
             ("difference", [ CProp ("plus", [ CVar 24; CVar 23 ]); CVar 23 ]);
           CProp ("fix", [ CVar 24 ]);
         ] ));
  add
    (CProp
  ...
  add
    (CProp
       ( "equal",
         [
           CProp
             ("times", [ CVar 23; CProp ("difference", [ CVar 2; CVar 22 ]) ]);
           CProp
             ( "difference",
               [
  ...
  add
    (CProp
       ( "equal",
         [
           CProp
             ("remainder", [ CProp ("times", [ CVar 23; CVar 25 ]); CVar 25 ]);
           CProp ("zero", []);
         ] ));
  add
    (CProp
       ...
       ( "equal",
         [
           CProp
             ( "difference",
               [
                 CProp ("add1", [ CProp ("plus", [ CVar 24; CVar 25 ]) ]);
                 CVar 25;
               ] );
           CProp ("add1", [ CVar 24 ]);
         ] ));
  ...
  add
    (CProp
       ( "equal",
         [
           CProp
             ("remainder", [ CProp ("times", [ CVar 24; CVar 23 ]); CVar 24 ]);
           CProp ("zero", []);
         ] ));
  add
    (CProp
       ( "equal",
         [
           CProp
             ( "equal",
               [ CProp ("times", [ CVar 0; CVar 1 ]); CProp ("one", []) ] );
           CProp
             ( "and",
               [
                 CProp
                   ("not", [ CProp ("equal", [ CVar 0; CProp ("zero", []) ]) ]);
                 CProp
                   ("not", [ CProp ("equal", [ CVar 1; CProp ("zero", []) ]) ]);
                 CProp ("numberp", [ CVar 0 ]);
                 CProp ("numberp", [ CVar 1 ]);
                 CProp
                   ("equal", [ CProp ("sub1", [ CVar 0 ]); CProp ("zero", []) ]);
                 CProp
                   ("equal", [ CProp ("sub1", [ CVar 1 ]); CProp ("zero", []) ]);
               ] );
         ] ));
  add
    (CProp
  ...
  add
    (CProp
       ("equal", [ CProp ("dsort", [ CVar 23 ]); CProp ("sort2", [ CVar 23 ]) ]));
  add
    (CProp
       ( "equal",
         [
         ...
         [
           CProp
             ( "quotient",
               [
                 CProp
                   ("plus", [ CVar 23; CProp ("plus", [ CVar 23; CVar 24 ]) ]);
                 CProp ("two", []);
               ] );
           CProp
             ( "plus",
                 ...
                 CProp
                   ( "difference",
                     [
                       CProp
                         ( "meaning",
                           [ CProp ("plus_tree", [ CVar 24 ]); CVar 0 ] );
  ...
  add
    (CProp
       ( "equal",
         [
           CProp
             ("assignment", [ CVar 23; CProp ("append", [ CVar 0; CVar 1 ]) ]);
           CProp
             ( "if",
               [
  ...
  add
    (CProp
       ( "equal",
         [
           CProp
             ("flatten", [ CProp ("cdr", [ CProp ("gother", [ CVar 23 ]) ]) ]);
           CProp
             ( "if",
               [
                 CProp ("listp", [ CVar 23 ]);
...
*)
    ...
    | Prop (head, [ test; yes; no ]) ->
        if head.name = "if" then
          if truep test true_lst then tautologyp yes true_lst false_lst
          else if falsep test false_lst then tautologyp no true_lst false_lst
          else
