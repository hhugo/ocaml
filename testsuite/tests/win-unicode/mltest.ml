...
let foreign_names =
  List.sort compare
    [
      ...
      (* "你好" *) "\x73\xC5\x93\x75\x72";
      (* "sœur" *) "e\204\129te\204\129" (* "été" *);
    ]
...
let to_create_and_delete_files =
  [
    ...
    (* "骆驼" *) "\215\167\215\162\215\158\215\156";
    (* "קעמל" *) "\216\167\217\136\217\134\217\185";
    (* "اونٹ" *) "L\225\186\161c \196\145\195\160";
    (* "Lạc đà" *) "\224\176\146\224\176\130\224\176\159\224\177\134";
    (* "ఒంటె" *)
    "\224\174\146\224\174\159\224\175\141\224\174\159\224\174\149\224\174\174\224\175\141";
    (* "ஒட்டகம்" *) "\217\136\216\180\216\170\216\177";
    (* "وشتر" *)
    "\224\164\137\224\164\183\224\165\141\224\164\159\224\165\141\224\164\176\224\164\131";
    (* "उष्ट्रः" *) "\216\167\217\186" (* "اٺ" *);
  ]
