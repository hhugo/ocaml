...
let error l x y z r c =
  Printf.fprintf stdout
    ...
    (string_of_fpclass (Float.classify_float c)) (List.hd r)

let success l = Printf.fprintf stdout "%s OK!\n" l

let fma_test l x y z r =
  let c = Float.fma x y z in
  if List.exists (fun i -> i = c) r then success l else error l x y z r c
...
let _ =
  let cases =
    [ "001", 0x1p+0, 0x2p+0, 0x3p+0, [ 0x5p+0 ];
      ...
      [ 0xf.ffffffffffff8p+1020 ]; "035", 0x0p+0, 0x1p+0, 0x1p+0, [ 0x1p+0 ];
      ...
      [ ~-.0x3.8000000000004p-1024 ];
      "276",
      0x7.ffffffffffffp-1024,
      0x8.0000000000008p-4,
      0x4p-1076,
      [ 0x4p-1024 ];
      "277",
      ~-.0x7.ffffffffffffp-1024,
      ...
      [ ~-.0x4p-1024 ]; "282", 0x4p-1076, 0x4p-1076, 0x8p+1020, [ 0x8p+1020 ];
      ...
      [ 0x4p-108; 0x0p+0 ];
      "302",
      0x4.0000000000004p-1024,
      0x2.0000000000002p-56,
      0x8p+1020,
      [ 0x8p+1020 ];
      "303",
      0x4.0000000000004p-1024,
