...
let current = ref 0
let accum = ref []
let record fmt (* args *) = Printf.kprintf (fun s -> accum := s :: !accum) fmt
...
let spec =
  Arg.(
    [ "-u", Unit f_unit, "Unit (0)"; "-b", Bool f_bool, "Bool (1)";
      "-s", Set r_set, "Set (0)"; "-c", Clear r_clear, "Clear (0)";
      "-str", String f_string, "String (1)";
      "-sstr", Set_string r_string, "Set_string (1)"; "-i", Int f_int, "Int (1)";
      "-si", Set_int r_int, "Set_int (1)"; "-f", Float f_float, "Float (1)";
...
let args1 =
  [| "prog"; "anon1"; "-u"; "-b"; "true"; "-s"; "anon2"; "-c"; "-str"; "foo";
    "-sstr"; "bar"; "-i"; "19"; "-si"; "42"; "-f"; "3.14"; "-sf"; "2.72";
    "anon3"; "-t"; "false"; "gee"; "1436"; "-sym"; "c"; "anon4"; "-rest"; "r1";
    "r2" |]

let args2 =
  [| "prog"; "anon1"; "-u"; "-b=true"; "-s"; "anon2"; "-c"; "-str=foo";
    "-sstr=bar"; "-i=19"; "-si=42"; "-f=3.14"; "-sf=2.72"; "anon3"; "-t";
    "false"; "gee"; "1436"; "-sym=c"; "anon4"; "-rest"; "r1"; "r2" |]
...
let test spec argv =
  ...
  let reference =
    [ "anon(anon1)"; "unit()"; "bool(true)"; "anon(anon2)"; "string(foo)";
      "int(19)"; "float(3.14)"; "anon(anon3)"; "bool(false)"; "string(gee)";
      "int(1436)"; "symbol(c)"; "anon(anon4)"; "rest(r1)"; "rest(r2)" ]
  in
