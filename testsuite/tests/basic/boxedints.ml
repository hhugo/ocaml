...
module Test32 (M : TESTSIG) = struct
  open M
  open Ops
  ...
  let _ =
    ...
    test 5 (unsigned_to_int min_int)
      ...
      | _ -> assert false);
    test 6
      (unsigned_to_int (of_int Stdlib.max_int))
      (match Sys.word_size with
    ...
    test 7 (of_string "0b01010111111000001100") (of_int 0b01010111111000001100);
    ...
    List.iter
      (fun (n, s) -> test n (to_string (of_string s)) s)
      [
        (1, "0");
        (2, "123");
        (3, "-456");
    ...
    List.iter
      (fun (n, s) -> test n (format "0x%X" (of_string s)) s)
      [
        (8, "0x0");
        (9, "0x123");
        (10, "0xABCDEF");
    ...
    test 8
      (add (of_string "0x12345678") (of_string "0x9ABCDEF"))
    ...
    test 8
      (sub (of_string "0x12345678") (of_string "0x9ABCDEF"))
      (of_string "0x8888889");
    ...
    test 12
      (mul (of_string "0x12345678") (of_string "0x9ABCDEF"))
    ...
    List.iter
      (fun (n, a, b, c) ->
        test n (logand (of_string a) (of_string b)) (of_string c))
      [
    ...
    List.iter
      (fun (n, a, b, c) ->
        test n (logor (of_string a) (of_string b)) (of_string c))
      [
    ...
    List.iter
      (fun (n, a, b, c) ->
        test n (logxor (of_string a) (of_string b)) (of_string c))
      [
    ...
    List.iter
      (fun (n, a, b, c) ->
        test n (shift_right_logical (of_string a) b) (of_string c))
      [
        (1, "2", 1, "1");
        (2, "4", 2, "1");
        (3, "0x10", 4, "1");
    ...
    test 1
      (testcomp (of_int 0) (of_int 0))
      (true, false, false, false, true, true, 0, 0);
    test 2
      (testcomp (of_int 1234567) (of_int 1234567))
      (true, false, false, false, true, true, 0, 0);
    test 3
      (testcomp (of_int 0) (of_int 1))
      (false, true, true, false, true, false, -1, -1);
    test 4
      (testcomp (of_int (-1)) (of_int 0))
      (false, true, true, false, true, false, -1, 1);
    test 5
      (testcomp (of_int 1) (of_int 0))
...
module Test64 (M : TESTSIG) = struct
  open M
  open Ops
  ...
  let _ =
    ...
    test 6 (unsigned_to_int (of_int Stdlib.max_int)) (Some Stdlib.max_int);
    ...
    List.iter
      (fun (n, s) -> test n ("0x" ^ format "%X" (of_string s)) s)
      [
        (8, "0x0");
        (9, "0x123");
        (10, "0xABCDEF");
        (11, "0x1234567812345678");
        (12, "0x7FFFFFFFFFFFFFFF");
    ...
    test 7 (add (of_int (-123)) (of_int (-456))) (of_int (-579));
    test 8
      (add (of_string "0x1234567812345678") (of_string "0x9ABCDEF09ABCDEF"))
    ...
    test 7 (sub (of_int (-123)) (of_int (-456))) (of_int 333);
    test 8
      (sub (of_string "0x1234567812345678") (of_string "0x9ABCDEF09ABCDEF"))
...
let _ =
  ...
  print_newline ();
  testing_function "-------- Int64 --------";
  let module B = Test64 (struct
    type t = int64
  ...
  print_newline ();
  testing_function "-------- Nativeint --------";
  (match Sys.word_size with
  | 32 ->
      let module C = Test32 (struct
        type t = nativeint
  ...
  | _ -> assert false);
  print_newline ();
  testing_function "--------- Conversions -----------";
  testing_function "nativeint of/to int32";
  test 1
    (Nativeint.of_int32 (Int32.of_string "0x12345678"))
    (Nativeint.of_string "0x12345678");
  test 2
    (Nativeint.to_int32 (Nativeint.of_string "0x12345678"))
    (Int32.of_string "0x12345678");
  if Sys.word_size = 64 then
    test 3
      (Nativeint.to_int32 (Nativeint.of_string "0x123456789ABCDEF0"))
      (Int32.of_string "0x9ABCDEF0")
  else test 3 0 0;
  (* placeholder to have the same output on 32-bit and 64-bit *)
  testing_function "int64 of/to int32";
  test 1
    (Int64.of_int32 (Int32.of_string "-0x12345678"))
    (Int64.of_string "-0x12345678");
  test 2
    (Int64.to_int32 (Int64.of_string "-0x12345678"))
    (Int32.of_string "-0x12345678");
  test 3
  ...
  test 1
    (Int64.of_nativeint (Nativeint.of_string "0x12345678"))
    (Int64.of_string "0x12345678");
  test 2
    (Int64.to_nativeint (Int64.of_string "-0x12345678"))
    (Nativeint.of_string "-0x12345678");
  test 3
    (Int64.to_nativeint (Int64.of_string "0x123456789ABCDEF0"))
    (if Sys.word_size = 64 then Nativeint.of_string "0x123456789ABCDEF0"
