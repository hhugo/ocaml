...
module Test32 (M : TESTSIG) = struct
  ...
  let _ =
    ...
    List.iter (fun (n, s) -> test n (to_string (of_string s)) s)
      [ 1, "0"; 2, "123"; 3, "-456"; 4, "1234567890"; 5, "1073741824";
        6, "2147483647"; 7, "-2147483648" ];
    List.iter (fun (n, s) -> test n (format "0x%X" (of_string s)) s)
      [ 8, "0x0"; 9, "0x123"; 10, "0xABCDEF"; 11, "0x12345678"; 12, "0x7FFFFFFF";
        13, "0x80000000"; 14, "0xFFFFFFFF" ];
    ...
    List.iter
      ...
      [ 1, 0, 2; 2, 123, 1; 3, (-123), 1; 4, 123, (-1); 5, (-123), (-1);
        6, 127531236, 365; 7, 16384, 256; 8, (-127531236), 365;
        9, 127531236, (-365); 10, 1234567, 12345678; 11, 1234567, (-12345678) ];
    test 12 (div min_int (of_int (-1))) min_int;
    testing_function "unsigned_div";
    List.iter (fun (n, a, b, c) -> test n (unsigned_div a b) c)
      [ 1, of_int 0, of_int 2, of_int 0; 2, of_int 123, of_int 1, of_int 123;
        ...
        8, of_int (-1), of_int 2, max_int; 9, of_int (-1), max_int, of_int 2;
    ...
    List.iter
      ...
      [ 1, "0x12345678", "0x9abcdef0", "0x12345670";
        ...
        3, "0xFFFFFFFF", "0x12345678", "0x12345678"; 4, "0", "0x12345678", "0";
    ...
    List.iter
      ...
      [ 1, "1", 1, "2"; 2, "1", 2, "4"; 3, "1", 4, "0x10";
        4, "1", 30, "0x40000000"; 5, "1", 31, "0x80000000";
        6, "0x16236", 7, "0xb11b00"; 7, "0x10", 27, "0x80000000";
        8, "0x10", 28, "0" ];
    testing_function "shift_right";
    List.iter
      (fun (n, a, b, c) -> test n (shift_right (of_string a) b) (of_string c))
      [ 1, "2", 1, "1"; 2, "4", 2, "1"; 3, "0x10", 4, "1";
        4, "0x40000000", 10, "0x100000"; 5, "0x80000000", 31, "-1";
        6, "0xb11b00", 7, "0x16236"; 7, "-0xb11b00", 7, "-90678" ];
    ...
    List.iter
      ...
      [ 1, "2", 1, "1"; 2, "4", 2, "1"; 3, "0x10", 4, "1";
        4, "0x40000000", 10, "0x100000"; 5, "0x80000000", 31, "1";
        6, "0xb11b00", 7, "0x16236"; 7, "-0xb11b00", 7, "0x1fe9dca" ];
...
module Test64 (M : TESTSIG) = struct
  ...
  let _ =
    ...
    testing_function "to_string, format";
    List.iter (fun (n, s) -> test n (to_string (of_string s)) s)
      [ 1, "0"; 2, "123"; 3, "-456"; 4, "1234567890"; 5, "1234567890123456789";
        6, "9223372036854775807"; 7, "-9223372036854775808" ];
    ...
    List.iter
      (fun (n, a, b, c) -> test n (shift_left (of_string a) b) (of_string c))
      [ 1, "1", 1, "2"; 2, "1", 2, "4"; 3, "1", 4, "0x10";
        4, "1", 62, "0x4000000000000000"; 5, "1", 63, "0x8000000000000000";
        6, "0x16236ABD45673", 7, "0xb11b55ea2b3980";
        7, "0x10", 59, "0x8000000000000000"; 8, "0x10", 60, "0" ];
    testing_function "shift_right";
    List.iter
      (fun (n, a, b, c) -> test n (shift_right (of_string a) b) (of_string c))
      [ 1, "2", 1, "1"; 2, "4", 2, "1"; 3, "0x10", 4, "1";
        4, "0x40000000", 10, "0x100000"; 5, "0x8000000000000000", 63, "-1";
...
let _ =
  ...
  test 3 (Int64.to_nativeint (Int64.of_string "0x123456789ABCDEF0"))
    (if Sys.word_size = 64 then
       ...
       Nativeint.of_string "0x9ABCDEF0")
