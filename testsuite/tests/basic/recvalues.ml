...
let _ =
  ...
  if match z with (1, 2) :: z' -> z == z' | _ -> false then
    print_string "Test 3: passed\n"
...
if (List.hd !(snd x2.(0))) () == s then print_string "Test 4: passed\n"
