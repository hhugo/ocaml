...
let ret_e1 (type a) (type b) (b : bool) (wit : (a, b) eq) (x : a) (y : b) =
  match wit with
...
let ret_e2 (type a) (type b) (b : bool) (wit : (a, b) eq) (x : a) (y : b) =
  match wit with
  | Refl -> if b then x else y
  | _ -> y
...
let ret_f (type a) (type b) (wit : (a, b) eq) (x : a) (y : b) =
  match wit with
  | Refl -> [ x; y ]
  | _ -> [ x ]
...
let ret_g1 (type a) (type b) (wit : (a, b) eq) (x : a) (y : b) =
  match wit with
  | Refl -> [ x; y ]
  | _ -> [ y ]
