...
class virtual comparable () =
  object ((self : 'a)) method virtual cmp : 'a -> int end
...
let l =
  [ new int_comparable 5; (new int_comparable3 2 :> int_comparable);
...
let rec fold_right f (l : 'a #link option) accu =
  match l with
  | None -> accu
  | Some l -> f l#x (fold_right f l#next accu)
