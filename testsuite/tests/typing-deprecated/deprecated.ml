...
let f = function bar, (cho [@deprecated]), _ -> cho + 1
...
type t = A of t [@@ocaml.deprecated] [@@ocaml.warning "-3"]
...
type t = A of (t[@ocaml.warning "-3"]) [@@ocaml.deprecated]
...
type ext += C of X.t [@@ocaml.warning "-3"]
...
type t =
  < a : X.t ; b : X.s [@ocaml.warning "-3"] ; c : (X.u[@ocaml.warning "-3"]) >
...
type t = (unit[@ocaml.ppwarning "Pp warning!"])
