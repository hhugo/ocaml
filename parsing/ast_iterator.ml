...
(* Type expressions for the core language *)
  ...
  let iter_extension_constructor
...
let default_iterator =
  {
    ...
    value_description =
      (fun
         this { pval_name; pval_type; pval_prim = _; pval_loc; pval_attributes }
       ->
