...
module Typ : sig
  ...
  val constr :
    ?loc:loc -> ?attrs:attrs -> lid -> core_type list -> core_type
...
module Pat : sig
  ...
  val construct :
    ?loc:loc -> ?attrs:attrs -> lid -> pattern option -> pattern

  val variant :
    ?loc:loc -> ?attrs:attrs -> label -> pattern option -> pattern
...
module Exp : sig
  ...
  val match_ :
    ?loc:loc -> ?attrs:attrs -> expression -> case list -> expression
...
module Sig : sig
  ...
  val type_ :
    ?loc:loc -> rec_flag -> type_declaration list -> signature_item
...
module Str : sig
  ...
  val type_ :
    ?loc:loc -> rec_flag -> type_declaration list -> structure_item
...
module Cty : sig
  ...
  val constr :
    ?loc:loc -> ?attrs:attrs -> lid -> core_type list -> class_type
...
module Cl : sig
  ...
  val constr :
    ?loc:loc -> ?attrs:attrs -> lid -> core_type list -> class_expr
