...
module Inlined = struct
  ...
  let summary ppf = function
    | Classic_mode ->
        Format.pp_print_text
          ppf
          "This function was inlined because it was small enough to be \
           inlined in `-Oclassic'"
    | Annotation ->
        Format.pp_print_text
          ppf
    ...
    | Decl_local_to_application ->
        Format.pp_print_text
          ppf
          "This function was inlined because it was local to this \
           application."
    | Without_subfunctions _ ->
        Format.pp_print_text
          ppf
          "This function was inlined because the expected benefit \
  ...
  let calculation ~depth ppf = function
    ...
    | Without_subfunctions wsb ->
        print_calculation
          ~depth
          ~title:"Inlining benefit calculation"
          ~subfunctions:false
          ppf
          wsb
...
module Not_inlined = struct
  ...
  let summary ppf = function
    ...
    | Without_subfunctions _ ->
        Format.pp_print_text
          ppf
          "This function was not inlined because the expected benefit did \
  ...
  let calculation ~depth ppf = function
    | Classic_mode | Above_threshold _ | Annotation
     |No_useful_approximations | Unrolling_depth_exceeded | Self_call ->
        ()
    | Without_subfunctions wsb ->
        print_calculation
          ~depth
...
module Specialised = struct
  ...
  let calculation ~depth ppf = function
    ...
    | Without_subfunctions wsb ->
        print_calculation
          ~depth
          ~title:"Specialising benefit calculation"
          ~subfunctions:false
          ppf
          wsb
    | With_subfunctions (_, wsb) ->
...
module Not_specialised = struct
  ...
  let summary ppf = function
    ...
    | Above_threshold size ->
        Format.pp_print_text
          ppf
          "This function was not specialised because it was larger than \
           the current size threshold";
        Format.fprintf ppf "(%i)" size
    | Annotation ->
        Format.pp_print_text
          ppf
  ...
  let calculation ~depth ppf = function
    | Classic_mode | Above_threshold _ | Annotation | Not_recursive
     |Not_closed | No_invariant_parameters | No_useful_approximations
     |Self_call ->
        ()
