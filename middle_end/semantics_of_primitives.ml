...
let for_primitive (prim : Clambda_primitives.primitive) =
  ...
  | Pmulfloat | Pdivfloat | Pfloatcomp _ ->
      (No_effects, No_coeffects)
  | Pstringlength | Pbyteslength | Parraylength _ ->
      (No_effects, Has_coeffects) (* That old chestnut: [Obj.truncate]. *)
  | Pisint | Pisout | Pbintofint _ | Pintofbint _ | Pcvtbint _ | Pnegbint _
  | Paddbint _ | Psubbint _ | Pmulbint _ | Pandbint _ | Porbint _ | Pxorbint _
  | Plslbint _ | Plsrbint _ | Pasrbint _ | Pbintcomp _ ->
      (No_effects, No_coeffects)
  | Pbigarraydim _ ->
      (No_effects, Has_coeffects) (* Some people resize bigarrays in place. *)
  | Pread_symbol _ | Pfield _ | Pfield_computed | Pfloatfield _ | Parrayrefu _
