...
let for_primitive (prim : Clambda_primitives.primitive) =
  ...
  | Pduparray (_, Immutable) -> No_effects, No_coeffects
  ...
  | Pfloatcomp _
    ->
    No_effects, No_coeffects
  | Pstringlength | Pbyteslength | Parraylength _ -> No_effects, Has_coeffects
  (* That old chestnut: [Obj.truncate]. *)
  | Pisint
  | Pisout
  | Pbintofint _
  | Pintofbint _
  ...
  | Pbintcomp _
    ->
    No_effects, No_coeffects
  | Pbigarraydim _ -> No_effects, Has_coeffects
