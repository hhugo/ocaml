...
let augment_with_kind t (kind : Lambda.value_kind) =
  ...
  | Pfloatval -> (
    ...
    | Value_block _ | Value_int _ | Value_char _ | Value_constptr _
     |Value_boxed_int _ | Value_set_of_closures _ | Value_closure _
     |Value_string _ | Value_float_array _ | Value_bottom ->
        (* Unreachable *)
...
let augment_kind_with_approx t (kind : Lambda.value_kind) :
    Lambda.value_kind =
  match t.descr with
...
let simplify t (lam : Flambda.t) : simplification_result =
  if Effect_analysis.no_effects lam
  then
    match t.descr with
    | Value_int n ->
...
let simplify_named t (named : Flambda.named) : simplification_result_named =
  if Effect_analysis.no_effects_named named
  then
    match t.descr with
    | Value_int n ->
...
let known t =
  ...
  | Value_string _ | Value_float_array _ | Value_bottom | Value_block _
   ...
   |Value_float _ | Value_boxed_int _ | Value_symbol _ ->
      true
...
let warn_on_mutation t =
  ...
  | Value_string {contents = None}
   |Value_float_array _ | Value_unresolved _ | Value_unknown _
   |Value_bottom ->
      false
...
let check_approx_for_block t =
  ...
  | Value_bottom | Value_int _ | Value_char _ | Value_constptr _
   |Value_float_array _ | Value_string _ | Value_float _
   |Value_boxed_int _ | Value_set_of_closures _ | Value_closure _
   |Value_symbol _ | Value_extern _ | Value_unknown _ | Value_unresolved _
    ->
      Wrong
...
let rec meet_descr ~really_import_approx d1 d2 =
  ...
  | Value_constptr i, Value_constptr j when i = j -> d1
...
let check_approx_for_closure_allowing_unresolved t :
  ...
  | Value_closure value_closure -> (
    ...
    | Value_unresolved _ | Value_closure _ | Value_block _ | Value_int _
     |Value_char _ | Value_constptr _ | Value_float _ | Value_boxed_int _
  ...
  | Value_set_of_closures _ | Value_block _ | Value_int _ | Value_char _
   |Value_constptr _ | Value_float _ | Value_boxed_int _ | Value_bottom
...
let check_approx_for_float t : float option =
  ...
  | Value_unresolved _ | Value_unknown _ | Value_string _
   ...
   |Value_char _ | Value_constptr _ | Value_set_of_closures _
   |Value_closure _ | Value_extern _ | Value_boxed_int _ | Value_symbol _ ->
      None
        ...
        (fun elt acc ->
          ...
          | None, _
           |( Some _
            , ( Value_float None
              | Value_unresolved _ | Value_unknown _ | Value_string _
              | Value_float_array _ | Value_bottom | Value_block _
              | Value_int _ | Value_char _ | Value_constptr _
              | Value_set_of_closures _ | Value_closure _ | Value_extern _
...
let check_approx_for_string t : string option =
  ...
  | Value_float _ | Value_unresolved _ | Value_unknown _
   |Value_float_array _ | Value_bottom | Value_block _ | Value_int _
   |Value_char _ | Value_constptr _ | Value_set_of_closures _
   |Value_closure _ | Value_extern _ | Value_boxed_int _ | Value_symbol _ ->
      None
...
let potentially_taken_const_switch_branch t branch =
  ...
  | Value_unresolved _ | Value_unknown _ | Value_extern _ | Value_symbol _
    ->
      ...
      Can_be_taken
  | (Value_constptr i | Value_int i) when i = branch -> Must_be_taken
  | Value_char c when Char.code c = branch -> Must_be_taken
  | Value_constptr _ | Value_int _ | Value_char _ -> Cannot_be_taken
  | Value_block _ | Value_float _ | Value_float_array _ | Value_string _
   |Value_closure _ | Value_set_of_closures _ | Value_boxed_int _
   |Value_bottom ->
      Cannot_be_taken
...
let function_declaration_approx ~keep_body fun_var
  ...
  let function_body =
    if not (keep_body fun_var fun_decl)
    then None
    else
      Some
        { body = fun_decl.body
...
let function_declarations_approx ~keep_body
  ...
  let funs =
    Variable.Map.mapi
      (function_declaration_approx ~keep_body)
      fun_decls.funs
  in
  { funs
