  ...
  let what_to_specialise ~env ~(set_of_closures : Flambda.set_of_closures) =
    ...
    then what_to_specialise
      ...
      let invariant_params_flow =
        Invariant_params.invariant_param_sources
        ...
        (fun fun_var extractions what_to_specialise ->
          Projection.Set.fold
            (fun (projection : Projection.t) what_to_specialise ->
              ...
              assert (
                Variable.Map.mem group set_of_closures.specialised_args );
              let what_to_specialise =
                W.new_specialised_arg
                  what_to_specialise
                  ~fun_var
                  ~group
                  ~definition:
              ...
              | flow ->
                  ...
                  Variable.Pair.Set.fold
                    (fun (target_fun_var, target_spec_arg)
                         what_to_specialise ->
