...
let is_known_to_be_some_kind_of_int (arg : A.descr) =
  ...
  | Value_block (_, _)
   ...
   |Value_string _ | Value_float_array _ | A.Value_boxed_int _
   |Value_unknown _ | Value_extern _ | Value_symbol _ | Value_unresolved _
   |Value_bottom ->
      false
...
let is_known_to_be_some_kind_of_block (arg : A.descr) =
  ...
  | Value_block _ | Value_float _ | Value_float_array _
   |A.Value_boxed_int _ | Value_closure _ | Value_string _ ->
      true
  | Value_set_of_closures _ | Value_int _ | Value_char _
   |Value_constptr _ | Value_unknown _ | Value_extern _ | Value_symbol _
...
let primitive (p : Clambda_primitives.primitive) (args, approxs) expr dbg
  ...
  | Pmakeblock (tag_int, Asttypes.Immutable, shape) ->
      ...
      ( Prim
          (Pmakeblock (tag_int, Asttypes.Immutable, Some shape), args, dbg)
  ...
  | Pintcomp Cne when phys_equal approxs -> S.const_bool_expr expr false
  ...
  | Pintcomp Cne when phys_different approxs -> S.const_bool_expr expr true
  ...
  | _ -> (
    ...
    | [A.Value_boxed_int (A.Nativeint, n1); Value_int n2] ->
        I.Simplify_boxed_nativeint.simplify_binop_int
          p
          Nativeint
          expr
          n1
    ...
    | [A.Value_boxed_int (A.Int32, n1); Value_int n2] ->
        I.Simplify_boxed_int32.simplify_binop_int
          p
          Int32
          expr
          n1
    ...
    | [A.Value_boxed_int (A.Int64, n1); Value_int n2] ->
        I.Simplify_boxed_int64.simplify_binop_int
          p
          Int64
          expr
          n1
