...
let print_constant_defining_value ppf =
  function
...
let rec resolve_definition
    (definitions : definitions) (var : Variable.t)
    (def : constant_defining_value) ~the_dead_constant
  :
  allocation_point
=
  match def with
...
and fetch_variable
    (definitions : definitions) (var : Variable.t) ~the_dead_constant
  :
  allocation_point
=
...
and fetch_variable_field
    (definitions : definitions) (var : Variable.t) (field : int)
    ~the_dead_constant
  :
  allocation_point
=
...
and fetch_symbol_field
    (definitions : definitions) (sym : Symbol.t) (field : int)
    ~the_dead_constant
  :
  allocation_point
=
...
let run variable initialize_symbol symbol ~the_dead_constant =
  ...
  Variable.Tbl.fold
    (fun var definition result ->
       ...
       in
       Variable.Map.add var definition result) definitions.variable
    Variable.Map.empty
