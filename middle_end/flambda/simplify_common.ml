...
let const_int_expr expr n =
  if Effect_analysis.no_effects_named expr then
    ...
    expr, A.value_int n, C.Benefit.zero
...
let const_char_expr expr c =
  if Effect_analysis.no_effects_named expr then
    ...
    expr, A.value_char c, C.Benefit.zero

let const_bool_expr expr b = const_int_expr expr (if b then 1 else 0)
...
let const_float_expr expr f =
  if Effect_analysis.no_effects_named expr then
    ...
    expr, A.value_float f, C.Benefit.zero
...
let const_boxed_int_expr expr t i =
  if Effect_analysis.no_effects_named expr then
    ...
    expr, A.value_boxed_int t i, C.Benefit.zero
