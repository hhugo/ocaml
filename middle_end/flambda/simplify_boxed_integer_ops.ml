...
module Simplify_boxed_integer_operator
  ...
  :
  Simplify_boxed_integer_ops_intf.S with type t := I.t
= struct
  ...
  let simplify_unop
      (p : Clambda_primitives.primitive) (kind : I.t A.boxed_int) expr (n : I.t)
  =
  ...
  let simplify_binop
      (p : Clambda_primitives.primitive) (kind : I.t A.boxed_int) expr
      (n1 : I.t) (n2 : I.t)
  =
  ...
  let simplify_binop_int
      (p : Clambda_primitives.primitive) (kind : I.t A.boxed_int) expr
      (n1 : I.t) (n2 : int) ~size_int
  =
    let eval op = S.const_boxed_int_expr expr kind (op n1 n2) in
