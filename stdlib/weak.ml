...
let create l =
  if not (0 <= l && l <= Obj.Ephemeron.max_ephe_length)
  then invalid_arg "Weak.create";
  create l
...
let set e o x =
  ...
  match x with None -> unset e o | Some x -> set' e o x
