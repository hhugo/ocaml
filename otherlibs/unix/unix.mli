...
val link :
  ?follow:(* thwart tools/sync_stdlib_docs *) bool -> string -> string -> unit
...
val dup :
  ?cloexec:(* thwart tools/sync_stdlib_docs *) bool -> file_descr -> file_descr
...
val symlink :
  ?to_dir:(* thwart tools/sync_stdlib_docs *) bool -> string -> string -> unit
