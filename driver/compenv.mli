  ...
  :  (Format.formatter
      *
      (start_from:Clflags.Compiler_pass.t
       ...
       -> unit)
      *
      (source_file:(* compile implementation *) string
       -> output_prefix:string
       -> unit)
      * (* compile interface *) string
      * (* ocaml module extension *) string)
...
*)
val parse_arguments
  : ?current:int ref -> string array ref -> Arg.anon_fun -> string -> unit
