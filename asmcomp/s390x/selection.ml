...
let pseudoregs_for_operation op arg res =
  ...
  | Iintop (Iadd | Isub | Imul | Iand | Ior | Ixor)
   |Iaddf | Isubf | Imulf | Idivf ->
      [|res.(0); arg.(1)|], res
  | Ispecific _ -> [|arg.(0); arg.(1); res.(0)|], [|res.(0)|]
  ...
  object (self)
    ...
    method! select_operation op args dbg =
     ...
     operands than the other instructions *)
      ...
      | Cor, _ ->
          self#select_logical Ior 0 ((1 lsl 32) - 1 (*0xFFFF_FFFF*)) args
      | Cxor, _ ->
          self#select_logical Ixor 0 ((1 lsl 32) - 1 (*0xFFFF_FFFF*)) args
    ...
    method select_logical op lo hi =
      function
