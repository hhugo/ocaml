...
let loc_arguments arg = calling_conventions 0 4 100 103 outgoing 0 arg

let loc_parameters arg =
  let loc, _ofs = calling_conventions 0 4 100 103 incoming 0 arg in
  loc

let loc_results res =
  let loc, _ofs = calling_conventions 0 4 100 103 not_supported 0 res in
  loc
...
let float_dwarf_reg_numbers =
  [|16; 17; 18; 19; 20; 21; 22; 23; 24; 28; 25; 29; 26; 30; 27; 31|]
...
let destroyed_at_c_call =
  Array.of_list
    (List.map
       phys_reg
       [0; 1; 2; 3; 4; 100; 101; 102; 103; 104; 105; 106; 107])
...
let safe_register_pressure = function Iextcall _ -> 4 | _ -> 9
