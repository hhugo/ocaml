...
let loc_results res =
  let (loc, _ofs) = calling_conventions 0 7 100 103 not_supported 0 res in
  loc
...
let destroyed_at_c_call =
  Array.of_list
    (List.map phys_reg [ 0; 1; 2; 3; 4; 100; 101; 102; 103; 104; 105; 106; 107 ])
