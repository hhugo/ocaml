...
let pseudoregs_for_operation op arg res =
  ...
  | Iextcall { func = "__aeabi_idivmod"; _ } -> (arg, [| r1 |])
...
class selector =
  object (self)
    ...
    method is_immediate_test _op n = Arch.is_immediate (Int32.of_int n)
    ...
    method! select_operation op args dbg =
      ...
      | Cdivi, args -> (self#iextcall "__aeabi_idiv" typ_int [], args)
      | Cmodi, args ->
    ...
    method private select_operation_softfp op args dbg =
      ...
      | Ccmpf comp, args ->
          ...
          ( Iintop_imm (Icomp (Iunsigned comp), 0),
            [
              Cop
                (Cextcall (func, typ_int, [ XFloat; XFloat ], false), args, dbg);
            ] )
      ...
      | Cstore (Single, init), [ arg1; arg2 ] ->
          let arg2' =
            Cop
              ( Cextcall ("__aeabi_d2f", typ_int, [ XFloat ], false),
                [ arg2 ],
                dbg )
          in
    ...
    method private select_operation_vfpv3 op args dbg =
      ...
      (* Recognize multiply and subtract *)
      | Csubf, [ Cop (Cmulf, args, _); arg ] -> (Ispecific Imulsubf, arg :: args)
      (* Recognize floating-point square root *)
      | Cextcall ("sqrt", _, _, false), args -> (Ispecific Isqrtf, args)
      (* Other operations are regular *)
      | op, args -> super#select_operation op args dbg
