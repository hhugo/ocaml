...
type integer_operation =
  ...
  | Icheckbound of {label_after_error : label option; spacetime_index : int}
...
let spacetime_node_hole_pointer_is_live_before insn =
  ...
  | Iop op -> (
    ...
    | Imove | Ispill | Ireload | Iconst_int _ | Iconst_float _
     |Iconst_symbol _ | Istackoffset _ | Iload _ | Istore _ | Inegf
     |Iabsf | Iaddf | Isubf | Imulf | Idivf | Ifloatofint | Iintoffloat
