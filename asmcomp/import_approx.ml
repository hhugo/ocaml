    ...
    let funs =
      Variable.Map.map
        (fun (function_decl : A.function_declaration) ->
          A.update_function_declaration_body
            function_decl
        ...
        let invariant_params =
          ...
          | exception Not_found ->
              ...
              then Variable.Map.empty
                ...
                Misc.fatal_errorf
                  "Set of closures ID %a not found in invariant_params \
                   (when importing [%a: %s])"
    ...
    | Value_closure
      ...
      -> (
        ...
        | Some value_set_of_closures ->
            A.value_closure
              ?set_of_closures_symbol:aliased_symbol
