...
let make_package_object ~ppf_dump members targetobj targetname coercion ~backend
    =
...
let package_object_files ~ppf_dump files targetcmx targetobj targetname coercion
    ~backend =
  let pack_path =
