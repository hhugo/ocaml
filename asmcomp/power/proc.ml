      ...
      if
        Array.fold_left
          (fun stk r ->
            ...
            match r.(0).loc with Stack _ -> true | _ -> stk)
          false loc
      then (loc, ofs)
      else (loc, 0)
...
let safe_register_pressure = function Iextcall _ -> 14 | _ -> 23
...
let reserved_stack_space_required () =
  match abi with ELF32 -> false | ELF64v1 | ELF64v2 -> true

let frame_required fd =
  let is_elf32 = match abi with ELF32 -> true | ELF64v1 | ELF64v2 -> false in
