...
let pseudoregs_for_operation op arg res =
  ...
  | Iconst_float _ | Inegf | Iabsf | Iaddf | Isubf | Imulf | Idivf | Ifloatofint
...
class selector =
  object (self)
    ...
    method! is_immediate op n =
      match op with
      | Iadd | Isub | Imul | Iand | Ior | Ixor | Icomp _ | Icheckbound -> true
    ...
    method! select_operation op args dbg =
      ...
      | Csubf ->
          self#select_floatarith Isubf (Ispecific Isubfrev) Ifloatsub
            Ifloatsubrev args
      | Cmulf -> self#select_floatarith Imulf Imulf Ifloatmul Ifloatmul args
      | Cdivf ->
          self#select_floatarith Idivf (Ispecific Idivfrev) Ifloatdiv
            Ifloatdivrev args
