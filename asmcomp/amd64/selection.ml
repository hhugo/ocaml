...
class selector =
  object (self)
    ...
    method select_addressing _chunk exp =
      ...
      if not (is_immediate d) then
        Iindexed 0, exp
      else
        match a with
        | Asymbol s -> Ibased (s, d), Ctuple []
    ...
    method! select_operation op args dbg =
      ...
      | Caddf -> self#select_floatarith true Iaddf Ifloatadd args
      | Csubf -> self#select_floatarith false Isubf Ifloatsub args
      | Cmulf -> self#select_floatarith true Imulf Ifloatmul args
      | Cdivf -> self#select_floatarith false Idivf Ifloatdiv args
      | Cextcall ("sqrt", _, _, false) ->
        begin match args with
        | [ Cop (Cload ((Double as chunk), _), [ loc ], _dbg) ] ->
          let (addr, arg) = self#select_addressing chunk loc in
          Ispecific (Ifloatsqrtf addr), [ arg ]
        | [ arg ] -> Ispecific Isqrtf, [ arg ]
        | _ -> assert false
        end
      ...
      | Cstore (((Word_int | Word_val) as chunk), _init) ->
        begin match args with
        | [ loc;
            Cop (Caddi, [ Cop (Cload _, [ loc' ], _); Cconst_int (n, _dbg) ], _)
          ]
      ...
      | Cextcall ("caml_bswap16_direct", _, _, _) -> Ispecific (Ibswap 16), args
    ...
    method select_floatarith commutative regular_op mem_op args =
      ...
      | [ Cop (Cload ((Double as chunk), _), [ loc1 ], _); arg2 ]
        ...
        Ispecific (Ifloatarithmem (mem_op, addr)), [ arg2; arg1 ]
      | [ arg1; arg2 ] -> regular_op, [ arg1; arg2 ]
      | _ -> assert false
