...
type bound_error_call = { bd_lbl : label; (* Entry label *) bd_frame : label }
(* Label of frame descriptor *)
...
type per_function_env =
  {
    ...
    (* used in amd64,i386,s390x *)(* record jump tables (for PPC64).  In order to reduce the size of the TOC,
    ...
    (* in reverse order *)(* pending literals *)
    ...
    (* used only in arm *)(* [size_literals] is the total space (in words) occupied
                             by pending literals. *)
