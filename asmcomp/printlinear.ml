...
let label ppf l = Format.fprintf ppf "L%i" l
...
let instr ppf i =
  ...
  | Lcondbranch3 (lbl0, lbl1, lbl2) ->
      ...
      in
      case 0 lbl0; case 1 lbl1; case 2 lbl2; fprintf ppf "@,endswitch"
  | Lswitch lblv ->
  ...
  | Lraise k -> fprintf ppf "%a %a" Printcmm.raise_kind k reg i.arg.(0) );
