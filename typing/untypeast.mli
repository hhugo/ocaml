...
type mapper =
  ...
  ; class_type_field :
      mapper -> Typedtree.class_type_field -> class_type_field
  ...
  ; open_declaration :
      mapper -> Typedtree.open_declaration -> open_declaration
  ; open_description :
      mapper -> Typedtree.open_description -> open_description
  ...
  ; type_declaration :
      mapper -> Typedtree.type_declaration -> type_declaration
