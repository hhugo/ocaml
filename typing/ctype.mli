...
val set_object_name : Ident.t -> type_expr list -> type_expr -> unit
...
val extract_concrete_typedecl : Env.t -> type_expr -> typedecl_extraction_result
...
val equal_private :
  Env.t -> type_expr list -> type_expr -> type_expr list -> type_expr -> unit
...
val inherit_class_signature :
  strict:bool -> Env.t -> class_signature -> class_signature -> unit

val update_class_signature : Env.t -> class_signature -> label list * label list
