...
let rec core_type i ppf x =
  ...
  | Ttyp_arrow (l, ct1, ct2) ->
      ...
      core_type i ppf ct1;
      core_type i ppf ct2
  | Ttyp_tuple l -> line i ppf "Ttyp_tuple\n"; list i core_type ppf l
  | Ttyp_constr (li, _, l) ->
...
and pattern i ppf x =
  ...
  | [] -> (
    ...
    | Tpat_tuple l -> line i ppf "Tpat_tuple\n"; list i pattern ppf l
    ...
    | Tpat_array l -> line i ppf "Tpat_array\n"; list i pattern ppf l
    | Tpat_or (p1, p2, _) ->
        line i ppf "Tpat_or\n"; pattern i ppf p1; pattern i ppf p2
    | Tpat_lazy p -> line i ppf "Tpat_lazy\n"; pattern i ppf p
    | Tpat_exception p ->
...
and expression i ppf x =
  ...
  | Texp_try (e, l) ->
      line i ppf "Texp_try\n"; expression i ppf e; list i case ppf l
  | Texp_tuple l -> line i ppf "Texp_tuple\n"; list i expression ppf l
  ...
  | Texp_field (e, li, _) ->
      line i ppf "Texp_field\n"; expression i ppf e; longident i ppf li
  | Texp_setfield (e1, li, _, e2) ->
      line i ppf "Texp_setfield\n";
      expression i ppf e1;
      longident i ppf li;
      expression i ppf e2
  | Texp_array l -> line i ppf "Texp_array\n"; list i expression ppf l
  ...
  | Texp_letexception (cd, e) ->
      ...
      expression i ppf e
  | Texp_assert e -> line i ppf "Texp_assert"; expression i ppf e
  | Texp_lazy e -> line i ppf "Texp_lazy"; expression i ppf e
  | Texp_object (s, _) -> line i ppf "Texp_object"; class_structure i ppf s
  | Texp_pack me -> line i ppf "Texp_pack"; module_expr i ppf me
...
and class_field_kind i ppf = function
  | Tcfk_concrete (o, e) ->
      ...
      expression i ppf e
  | Tcfk_virtual t -> line i ppf "Virtual\n"; core_type i ppf t
