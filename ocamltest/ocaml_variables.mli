...
val bytecc_libs : Variables.t (** Libraries to link with for bytecode *)
...
val mkdll : Variables.t (** Command used to make a DLL *)

val mkexe : Variables.t (** Command used to build an executable program *)

val module_ : Variables.t
val modules : Variables.t
val nativecc_libs : Variables.t (** Libraries to link with for native code *)
