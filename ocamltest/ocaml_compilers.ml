...
class compiler
    ~(name:string) ~(flags:string) ~(directory:string)
...
=
  object (self)
    inherit
    Ocaml_tools.tool ~name ~family:"compiler" ~flags ~directory
    ...
    method program_variable =
      if Ocaml_backends.is_native host then
...
let ocamlc_byte =
  new compiler ~name:Ocaml_commands.ocamlrun_ocamlc ~flags:""
...
let ocamlc_opt =
  new compiler ~name:Ocaml_files.ocamlc_dot_opt ~flags:""
...
let ocamlopt_byte =
  new compiler ~name:Ocaml_commands.ocamlrun_ocamlopt ~flags:""
...
let ocamlopt_opt =
  new compiler ~name:Ocaml_files.ocamlopt_dot_opt ~flags:""
