...
let unix =
  make_library_modifier "unix" [ compiler_subdir [ "otherlibs"; unixlibdir ] ]
...
let systhreads =
  unix @
    make_library_modifier "threads"
      [ compiler_subdir [ "otherlibs"; "systhreads" ] ]

let compilerlibs_subdirs =
  [ "asmcomp"; "bytecomp"; "compilerlibs"; "driver"; "file_formats"; "lambda";
    "middle_end"; "parsing"; "toplevel"; "typing"; "utils" ]
...
let _ =
  ...
  List.iter
    ...
    [ "ocamlcommon"; "ocamlbytecomp"; "ocamlmiddleend"; "ocamloptcomp";
      "ocamltoplevel" ];
