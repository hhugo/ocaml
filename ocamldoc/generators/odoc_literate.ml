  ...
  class html =
    object (self)
      ...
      method private code_block b code =
        code_id <- code_id + 1;
        Printf.bprintf b
          "<span class=\"code_expand\" \
           onclick=\"if(document.getElementById('code%d').style.display=='none') \
           {document.getElementById('code%d').style.display='block';} else \
           {document.getElementById('code%d').style.display='none';}\"><img \
           src=\"expand_collapse.png\" alt=\"+/-\"/></span>" code_id code_id
          code_id;
      ...
      method! private html_of_value b v =
        ...
        | None -> ()
        | Some code -> self#code_block b code
...
*)
      ...
      [ "a:visited {color : #416DFF; text-decoration : none; }";
        ...
        "a:hover {color : Red; text-decoration : none; background-color: \
         #5FFF88}"; "a:active {color : Red; text-decoration : underline; }";
        ".keyword { font-weight : bold ; color : Red }";
        ".keywordsign { color : #C04600 }"; ".superscript { font-size : 0.6em }";
        ".subscript { font-size : 0.6em }"; ".comment { color : Green }";
        ...
        "div.h9 { font-size : 20pt ; border: 1px solid #000000; " ^
          "margin-top: 5px; margin-bottom: 2px;" ^
            "text-align: center; background-color: #FFFFFF ; " ^
              "padding: 2px; }"; ".typetable { border-style : hidden }";
        ".indextable { border-style : hidden }";
        ".paramstable { border-style : hidden ; padding: 5pt 5pt}";
        "body { background-color : White }"; "tr { background-color : White }";
        ...
        "div.codeblock { " ^
          "margin-left: 2em; margin-right: 1em; padding: 6px; " ^
            "margin-bottom: 8px; display: none; " ^
              "border-width: 1px 1px 1px 3px; border-style: solid; border-color: \
               grey; }";
        "span.code_expand { color: blue; text-decoration: underline; cursor: \
         pointer; " ^
          "margin-left: 1em ; } " ]
    end
end
