...
module Search (P : Predicates) : sig
  val search_section :
    Odoc_types.text -> string -> P.t -> result_element list
...
val exceptions :
  Odoc_module.t_module list -> Odoc_exception.t_exception list
...
val module_types :
  Odoc_module.t_module list -> Odoc_module.t_module_type list
...
val find_section :
  Odoc_module.t_module list -> Str.regexp -> Odoc_types.text
