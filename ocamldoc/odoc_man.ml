...
class virtual info =
  object (self)
    ...
    method str_man_of_text t =
      ...
      self#man_of_text b t; Buffer.contents b
      ...
      | l ->
          ...
          let rec iter = function
            ...
            | (v, text) :: q -> (
                ...
                bs b "\n";
                bs b "\n";
                match q with [] -> () | _ -> bs b linebreak; iter q )
          in
          iter l; Buffer.contents b
  ...
  class man =
    ...
    object (self)
      ...
      method man_of_text_element b txt =
        ...
        | Odoc_info.Superscript t -> bs b "^"; self#man_of_text2 b t
        | Odoc_info.Subscript t -> bs b "_"; self#man_of_text2 b t
        ...
        | Odoc_info.Target (target, code) ->
            self#man_of_Target b ~target ~code
      ...
      method man_of_type b t =
        ...
        (match t.ty_parameters with [] -> () | _ -> bs b ".I ");
      ...
      method man_of_included_module b m_name im =
        ...
        | Some mmt ->
            let name =
              match mmt with Mod m -> m.m_name | Modtype mt -> mt.mt_name
            in
      ...
      method generate_for_class cl =
        ...
        try
          ...
          bs
            b
            ( "\""
            ^ (match !Global.title with Some t -> t | None -> "")
            ^ "\"\n" );
          let abstract =
            ...
            | Some {i_desc = Some t} ->
                let s =
                  Odoc_info.string_of_text
                    (Odoc_info.first_sentence_of_text t)
                in
...
*)
      ...
      method man_of_module_type_body b mt =
        ...
        self#man_of_module_parameter_list
          b
          ""
        ...
        let all_items =
          List.filter
            (fun r ->
              match r with
              | Res_section _ -> false
              | Res_module _ | Res_module_type _ | Res_class _
               |Res_class_type _ ->
                  true
              | _ -> not mini )
            all_items_pre
          ...
          | h :: q -> (
            ...
            | h2 :: _ ->
                ...
                then
                  if List.mem h acc2
                  then f acc1 acc2 q
                  else f acc1 (acc2 @ [h]) q
                else f (acc2 :: acc1) [h] q )
        in
        f [] [] sorted_items
          ...
          let f ele =
            ...
            | Res_extension x ->
                bs
                  ...
                  ^ Odoc_messages.modul
                  ^ " "
                  ^ Name.father x.xt_name
                  ^ "\n" );
                self#man_of_type_extension
                  b
                  (Name.father x.xt_name)
                  x.xt_type_extension
            | Res_exception e ->
