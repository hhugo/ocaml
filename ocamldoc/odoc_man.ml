...
(*                                                                        *)
(**************************************************************************)
open Odoc_info (** The man pages generator. *)
...
module Generator = struct
  ...
  class man =
    ...
    object (self)
      ...
      method private man_of_text2 b t = List.iter (self#man_of_text_element b) t
      ...
      method man_of_text_element b txt =
        ...
        | Odoc_info.CodePre s ->
          ...
          bs b "\n.EE"
        | Odoc_info.Verbatim s -> bs b (self#escape s)
        | Odoc_info.Bold t
        | Odoc_info.Italic t
        ...
        | Odoc_info.Latex _ ->
          ...
          ()
        | Odoc_info.Link (_, t) -> self#man_of_text2 b t
      ...
      method relative_idents m_name s =
        let f str_t =
          ...
          Odoc_info.apply_if_equal Odoc_info.use_hidden_modules match_s
      ...
      method man_of_cstr_args ?par b m_name sep l =
        ...
        | Cstr_tuple l ->
          ...
          bs b (self#relative_idents m_name s2);
          bs b "\n"
        | Cstr_record l -> self#man_of_record m_name b l
      ...
      method man_of_exception b e =
        ...
        bs b " \n";
        begin match e.ex_args, e.ex_ret with
        | Cstr_tuple [], None -> ()
        | _, None ->
          bs b ".B of ";
          self#man_of_cstr_args ~par:false b (Name.father e.ex_name) " * "
            e.ex_args
        | Cstr_tuple [], Some r ->
          bs b ".B : ";
        ...
        | l, Some r ->
          bs b ".B : ";
          self#man_of_cstr_args ~par:false b (Name.father e.ex_name) " * " l;
          bs b ".B -> ";
          self#man_of_type_expr b (Name.father e.ex_name) r
        end;
      ...
      method man_of_record father b l =
        ...
        List.iter
          (fun r ->
             ...
             bs b ";";
             self#field_comment b r.rf_text) l;
        bs b "\n }\n"
        ...
        | Some (Object_type l) ->
          ...
          List.iter
            (fun r ->
               ...
               bs b ";";
               self#field_comment b r.of_text) l;
          bs b "\n >\n"
        | Some (Other typ) ->
          bs b "= ";
          (if priv then bs b "private ");
        ...
        | Type_variant l ->
          ...
          List.iter
            (fun constr ->
               ...
               | Cstr_tuple [], Some t, None -> print_text t
               | l, None, None ->
                 bs b "\n.B of ";
                 self#man_of_cstr_args ~par:false b father " * " l;
                 bs b " "
      ...
      method man_of_attribute b a =
        ...
        self#man_of_type_expr b (Name.father a.att_value.val_name)
      ...
      method man_of_method b m =
        ...
        self#man_of_type_expr b (Name.father m.met_value.val_name)
      ...
      method man_of_modtype b mt =
        ...
        | None -> ()
        | Some t -> self#man_of_module_type b (Name.father mt.mt_name) t
        end;
        bs b "\n.sp\n";
      ...
      method man_of_const b modname c =
        ...
        | Cstr_tuple (h :: q) ->
          ...
          List.iter
            (fun ty ->
               bs b " * ";
               self#man_of_type_expr b modname ty) q
      ...
      method generate_for_class cl =
        ...
        try
          ...
          let abstract =
            ...
            | Some { i_desc = Some t } ->
              let s =
                Odoc_info.string_of_text (Odoc_info.first_sentence_of_text t)
              in
...
*)
          ...
          List.iter
            (fun element ->
               match element with
               | Class_attribute a -> self#man_of_attribute b a
               | Class_method m -> self#man_of_method b m
               | Class_comment t -> self#man_of_class_comment b t)
...
*)
      ...
      method man_of_module_type_body b mt =
        ...
        self#man_of_module_parameter_list b ""
        ...
        List.iter
          (fun ele ->
             match ele with
             | Element_module m -> self#man_of_module b m
             | Element_module_type mt -> self#man_of_modtype b mt
             | Element_included_module im ->
               self#man_of_included_module b mt.mt_name im
             | Element_class c -> self#man_of_class b c
             | Element_class_type ct -> self#man_of_class_type b ct
             | Element_value v -> self#man_of_value b v
             | Element_type_extension te ->
               self#man_of_type_extension b mt.mt_name te
             | Element_exception e -> self#man_of_exception b e
             | Element_type t -> self#man_of_type b t
             | Element_module_comment text -> self#man_of_module_comment b text)
      ...
      method create_groups mini module_list =
        ...
        in
        let all_items_pre =
          Odoc_info.Search.search_by_name module_list (Str.regexp ".*")
        in
        let all_items =
          List.filter
            (fun r ->
               ...
               | Res_class_type _
                 ->
                 true
               | _ -> not mini) all_items_pre
        in
        let sorted_items =
          List.sort (fun e1 e2 -> compare (name e1) (name e2)) all_items
        in
        let rec f acc1 acc2 l =
          match l with
          | [] -> acc2 :: acc1
          | h :: q ->
            begin match acc2 with
            | [] -> f acc1 [ h ] q
            | h2 :: _ ->
        ...
        try
          ...
          let f ele =
            ...
            | Res_value v ->
              bs b
                ("\n.SH " ^
                   Odoc_messages.modul ^ " " ^ Name.father v.val_name ^ "\n");
              self#man_of_value b v
            | Res_type t ->
              bs b
                ("\n.SH " ^
                   Odoc_messages.modul ^ " " ^ Name.father t.ty_name ^ "\n");
              self#man_of_type b t
            | Res_extension x ->
              bs b
                ("\n.SH " ^
                   Odoc_messages.modul ^ " " ^ Name.father x.xt_name ^ "\n");
              self#man_of_type_extension b (Name.father x.xt_name)
                x.xt_type_extension
            | Res_exception e ->
              bs b
                ("\n.SH " ^
                   Odoc_messages.modul ^ " " ^ Name.father e.ex_name ^ "\n");
            ...
            | Res_class c ->
              bs b
                ("\n.SH " ^
                   Odoc_messages.modul ^ " " ^ Name.father c.cl_name ^ "\n");
              self#man_of_class b c
            | Res_class_type ct ->
              bs b
                ("\n.SH " ^
                   Odoc_messages.modul ^ " " ^ Name.father ct.clt_name ^ "\n");
              self#man_of_class_type b ct
            | Res_recfield (ty, f) ->
              bs b ("\n.SH Type " ^ ty.ty_name ^ "\n");
            ...
            | Res_module m ->
              (if Name.father m.m_name <> "" then
                 (bs b
                    ("\n.SH " ^
                       Odoc_messages.modul ^ " " ^ Name.father m.m_name ^ "\n");
                  bs b (Odoc_messages.modul ^ "\n");
                  bs b (".BI \"" ^ Name.simple m.m_name ^ "\"\n");
                  bs b " : ";
                  self#man_of_module_type b (Name.father m.m_name) m.m_type)
            ...
            | Res_module_type mt ->
              bs b
                ("\n.SH " ^
                   Odoc_messages.modul ^ " " ^ Name.father mt.mt_name ^ "\n");
              bs b (Odoc_messages.module_type ^ "\n");
              bs b (".BI \"" ^ Name.simple mt.mt_name ^ "\"\n");
              bs b " = ";
              begin match mt.mt_type with
      ...
      method generate module_list =
        let sorted_module_list =
          List.sort (fun m1 m2 -> compare m1.m_name m2.m_name) module_list
        in
