...
module Extension : sig
  ...
  val extension_constructors :
    t_type_extension -> t_extension_constructor list
...
module Class : sig
  ...
  val class_type_elements :
    ?trans:bool -> t_class_type -> class_element list
...
module Module : sig
  ...
  val module_included_modules :
    ?trans:bool -> t_module -> included_module list
  ...
  val module_exceptions :
    ?trans:bool -> t_module -> Exception.t_exception list
  ...
  val module_class_types :
    ?trans:bool -> t_module -> Class.t_class_type list
...
val string_of_type_list :
  ?par:bool -> string -> Types.type_expr list -> string
...
val string_of_type_extension_param_list :
  Extension.t_type_extension -> string
(** This function returns a string to represent the list of type parameters
