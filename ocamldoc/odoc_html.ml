...
module Naming = struct
  ...
  let module_type_target mt =
    target mark_module_type (Name.simple mt.mt_name)
  ...
  let method_target m =
    target mark_method (Name.simple m.met_value.val_name)
  ...
  object (self)
    ...
    method html_of_text_with_p b t =
      ...
      *)
      ...
      let flush b' =
        ...
        if s <> "" then ( bp b "<p>"; bs b s; bp b "</p>\n" );
        Buffer.clear b'
      in
      let rec iter txt =
        match txt with
    ...
    method html_of_text_element b txt =
      ...
      | Odoc_info.Target (target, code) ->
          self#html_of_Target b ~target ~code
        ...
        | Some first -> (
            let rec iter_last n =
              ...
              then None
                ...
                match s.[n] with '\t' -> iter_last (n - 1) | _ -> Some n
            in
    ...
    method html_of_Bold b t = bs b "<b>"; self#html_of_text b t; bs b "</b>"

    method html_of_Italic b t =
      bs b "<i>"; self#html_of_text b t; bs b "</i>"

    method html_of_Emphasize b t =
      bs b "<em>"; self#html_of_text b t; bs b "</em>"

    method html_of_Center b t =
      bs b "<center>"; self#html_of_text b t; bs b "</center>"

    method html_of_Left b t =
      bs b "<div align=left>"; self#html_of_text b t; bs b "</div>"

    method html_of_Right b t =
      bs b "<div align=right>"; self#html_of_text b t; bs b "</div>"
    ...
    method html_of_Block b t =
      bs b "<blockquote>\n"; self#html_of_text b t; bs b "</blockquote>\n"
    ...
    method html_of_Ref b name ref_opt text_opt =
      ...
      | Some kind ->
          ...
          let target, text =
            match kind with
            | Odoc_info.RK_module | Odoc_info.RK_module_type
            ...
            | Odoc_info.RK_const ->
                Naming.complete_const_target name, h name
          in
          let text =
            match text_opt with None -> [text] | Some text -> text
          in
          bs b ("<a href=\"" ^ target ^ "\">");
          self#html_of_text b text;
          bs b "</a>"
  ...
  object (self)
    ...
    method html_of_sees b l =
      ...
      | _ ->
          ...
          List.iter
            (fun see -> bs b "<li>"; self#html_of_see b see; bs b "</li>\n")
            l;
          bs b "</ul></li>\n"
  ...
  class html =
    object (self)
      ...
      val mutable default_style_options =
        ...
        ; ".indextable td, .indextable th {border: 1px #ddd solid; \
           min-width: 80px}"
        ; ".indextable td.module {background-color: #eee ;  padding-left: \
           2px; padding-right: 2px}"
        ...
        ; ".indextable tr td div.info { margin-left: 2px; margin-right: \
           2px }"
      ...
      method index_values =
        Printf.sprintf "%s_values.html" self#index_prefix
      ...
      method index_methods =
        Printf.sprintf "%s_methods.html" self#index_prefix

      (** The file for the index of classes. *)
      method index_classes =
        Printf.sprintf "%s_classes.html" self#index_prefix
      ...
      method index_modules =
        Printf.sprintf "%s_modules.html" self#index_prefix
      ...
      method init_style =
        ...
        | None -> (
            ...
            with Sys_error s -> prerr_endline s; incr Odoc_info.errors )
        | Some f -> style_file <- f );
        style <-
      ...
      (** Get the page header. *)
      method print_header b ?nav ?comments title =
        header b ?nav ?comments title
        ...
        let f b ?(nav = None) ?(comments = []) t =
          ...
          | Some (pre_opt, post_opt, name) ->
              ...
              let href =
                if father = ""
                then self#index
                else fst (Naming.html_files father)
              in
      ...
      method private output_code ?(with_pre = true) in_title file code =
        try
          ...
          close_out chanout
        with Sys_error s -> incr Odoc_info.errors; prerr_endline s
      ...
      method create_fully_qualified_idents_links m_name s =
        ...
        let f str_t =
          ...
          in
          if known_type
             || (retry && String.Set.mem match_s known_types_names)
          then
            "<a href=\""
      ...
      method html_of_module_kind b father ?modu kind =
        ...
        | Module_alias a ->
            ...
            bs
              b
              (self#create_fully_qualified_module_idents_links
                 father
                 a.ma_name);
            bs b "</code>"
        | Module_functor (p, k) ->
      ...
      method html_of_type b t =
        ...
        | Type_record l ->
            ...
            self#html_of_record
              ~father
              ~close_env
              (Naming.recfield_target t)
              b
              l
        | Type_open -> bs b "= .."; bs b "</pre>" );
        bs b "\n";
      ...
      method html_of_class_kind b father ?cl kind =
        ...
        | Class_constr cco ->
            ...
            bs
              b
              (self#create_fully_qualified_idents_links father cco.cco_name);
            bs b "</code>"
      ...
      method html_of_class_type_kind b father ?ct kind =
        ...
        | Class_type cta ->
            ...
            bs
              b
              (self#create_fully_qualified_idents_links father cta.cta_name);
            bs b "</code>"
      ...
      method generate_elements_index
          : 'a.    'a list -> ('a -> Odoc_info.Name.t)
            -> ('a -> Odoc_info.info option) -> ('a -> string) -> string
            -> string -> unit =
          ...
          try
            ...
            let f_group l =
              ...
              | e :: _ ->
                  let s =
                    match
                      Char.uppercase_ascii (Name.simple (name e)).[0]
                    with
      ...
      method generate_for_class_type pre post clt =
        ...
        let type_file =
          Naming.file_type_class_complete_target clt.clt_name
        in
        try
          let chanout =
            open_out (Filename.concat !Global.target_dir html_file)
      ...
      method generate_for_module_type pre post mt =
        try
          let html_file, _ = Naming.html_files mt.mt_name in
          let type_file =
            Naming.file_type_module_complete_target mt.mt_name
          in
          let chanout =
            open_out (Filename.concat !Global.target_dir html_file)
          in
      ...
      method generate_for_module pre post modu =
        try
          ...
          let type_file =
            Naming.file_type_module_complete_target modu.m_name
          in
          let code_file =
            Naming.file_code_module_complete_target modu.m_name
          in
          let chanout =
            open_out (Filename.concat !Global.target_dir html_file)
          in
      ...
      method generate module_list =
        ...
        with Failure s -> prerr_endline s; incr Odoc_info.errors
