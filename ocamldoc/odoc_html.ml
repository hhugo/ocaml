...
class virtual text =
  object (self)
    inherit ocaml_code (** We want to display colorized code. *)
        ...
        | Some first ->
          let rec iter_last n =
            if n <= first then
              ...
              | _ -> Some n
          in
          begin match iter_last (len - 1) with
    ...
    object (self)
      ...
      val mutable default_style_options =
        [ ".keyword { font-weight : bold ; color : Red }";
          ".keywordsign { color : #C04600 }"; ".comment { color : Green }";
          ".constructor { color : Blue }"; ".type { color : #5C6585 }";
          ".string { color : Maroon }";
          ".warning { color : Red ; font-weight : bold }";
          ".info { margin-left : 3em; margin-right: 3em }";
          ".param_info { margin-top: 4px; margin-left : 3em; margin-right : \
           3em }"; ".code { color : #465F91 ; }";
          ".typetable { border-style : hidden }";
          ".paramstable { border-style : hidden ; padding: 5pt 5pt}";
          "tr { background-color : White }";
          "td.typefieldcomment { background-color : #FFFFFF ; font-size: \
           smaller ;}"; "div.sig_block {margin-left: 2em}";
          ...
          "div.h10 { font-size : 20pt ; border: 1px solid #000000; " ^
            "margin-top: 5px; margin-bottom: 2px;" ^
              "text-align: center; background-color: #FFFFFF ; " ^
                "padding: 2px; }"; "a {color: #416DFF; text-decoration: none}";
      ...
      val mutable style_file = "style.css" (** The style file for all pages. *)
      ...
      method prepare_header module_list =
        let f b ?(nav=None) ?(comments=[]) t =
          ...
          bs b self#index;
          bs b "\">\n";
          begin match nav with
          | None -> ()
          | Some (pre_opt, post_opt, name) ->
            begin match pre_opt with
            | None -> ()
            | Some name ->
          ...
          (bs b "<div class=\"navbar\">";
           ...
           | Some name ->
             bp b "<a class=\"pre\" href=\"%s\" title=\"%s\">%s</a>\n"
               (fst (Naming.html_files name)) name Odoc_messages.previous
           end;
           bs b "&nbsp;";
           let father = Name.father name in
           let href =
           ...
           | Some name ->
             bp b "<a class=\"post\" href=\"%s\" title=\"%s\">%s</a>\n"
               (fst (Naming.html_files name)) name Odoc_messages.next
           end;
           bs b "</div>\n")
      ...
      method create_fully_qualified_idents_links m_name s =
        ...
        let f str_t =
          ...
          in
          if
            known_type || retry && String.Set.mem match_s known_types_names
          then
            "<a href=\"" ^
              Naming.complete_target Naming.mark_type match_s ^
                "\">" ^ s_final ^ "</a>"
          else if
            known_class || retry && String.Set.mem match_s known_classes_names
          then
        ...
        Str.global_substitute
          (Str.regexp
             "\\([A-Z]\\([a-zA-Z_'0-9]\\)*\\.\\)+\\([a-z][a-zA-Z_'0-9]*\\)") f s
      ...
      method create_fully_qualified_module_idents_links m_name s =
        let f str_t =
          ...
          in
          if
            known_module || retry && String.Set.mem match_s known_modules_names
          then
            let (html_file, _) = Naming.html_files match_s in
            "<a href=\"" ^ html_file ^ "\">" ^ s_final ^ "</a>"
          else
      ...
      method html_of_cstr_args ?par b m_name c_name sep l =
        ...
        | Cstr_record l ->
          ...
          self#html_of_record ~father:m_name ~close_env:"</code>"
            (Naming.inline_recfield_target m_name c_name) b l
      ...
      method html_of_module_kind b father ?modu kind =
        ...
        | Module_unpack (code, mta) ->
          bs b "<code class=\"type\">";
          begin match mta.mta_module with
          | None ->
            bs b
      ...
      method html_of_module_parameter b father p =
        ...
        in
        self#html_of_text b
          [ Code (s_functor ^ "("); Code p.mp_name; Code " : " ];
      ...
      method html_of_type_extension b m_name te =
        ...
        let print_one x =
          ...
          begin match x.xt_args, x.xt_ret with
          | Cstr_tuple [], None -> ()
          | l, None ->
          ...
          | Some xa ->
            ...
            | Some x ->
              bp b "<a href=\"%s\">%s</a>" (Naming.complete_extension_target x)
                x.xt_name
            end
          end;
          bs b "</code></td>\n";
      ...
      method html_of_exception b e =
        ...
        | Some ea ->
          ...
          | Some e ->
            bp b "<a href=\"%s\">%s</a>" (Naming.complete_exception_target e)
              e.ex_name
          end
        end;
        bs b "</pre>\n";
      ...
      method html_of_type b t =
        ...
        in
        bs b
          begin match t.ty_manifest, t.ty_kind with
        ...
        begin match t.ty_parameters with
        | [] -> ()
        | _ -> bs b " "
        end;
        ...
        | Some (Object_type fields) ->
          ...
          let print_one f =
            ...
            bp b "<span id=\"%s\">%s</span>&nbsp;: "
              (Naming.objfield_target t f) f.of_name;
        ...
        | Type_variant l ->
          ...
          let print_one constr =
            print_bar ();
            bp b "<span id=\"%s\">%s</span>" (Naming.const_target t constr)
            ...
            bs b "</code></td>\n";
            begin match constr.vc_text with
            | None -> ()
            | Some t ->
              bs b
                "<td class=\"typefieldcomment\" align=\"left\" \
      ...
      method html_of_attribute b a =
        ...
        (if a.att_mutable then
           ...
           ());
        begin match a.att_value.val_code with
        ...
        | Some c ->
          ...
          self#output_code a.att_value.val_name
            (Filename.concat !Global.target_dir file) c;
      ...
      method html_of_method b m =
        ...
        begin match m.met_value.val_code with
      ...
      method html_of_parameter_description b p =
        ...
        | name :: [] ->
          ...
          begin match Parameter.desc_by_name p name with
          | None -> ()
          | Some t -> self#html_of_text b t
          end
        | l ->
          (*  A list of names, we display those with a description. *)
          let l2 = List.filter (fun n -> Parameter.desc_by_name p n <> None) l
          in
          let print_one n =
          ...
          let print_one p =
            bs b
              "<tr>\n\
               ...
               class=\"code\">\n";
            bs b
              begin match Parameter.complete_name p with
              | "" -> "?"
              | s -> s
              end;
      ...
      method html_of_described_parameter_list b _m_name l =
        ...
        let l2 =
          List.filter
            (fun p ->
               List.exists (fun n -> Parameter.desc_by_name p n <> None)
                 (Parameter.names p)) l
        in
        let f p =
      ...
      method html_of_module
          b ?(info=true) ?(complete=true) ?(with_link=true) m
      =
        let (html_file, _) = Naming.html_files m.m_name in
      ...
      method html_of_modtype
          b ?(info=true) ?(complete=true) ?(with_link=true) mt
      =
        let (html_file, _) = Naming.html_files mt.mt_name in
      ...
      method html_of_class_kind b father ?cl kind =
        ...
        | Class_constr cco ->
          begin match cco.cco_type_parameters with
          | [] -> ()
          | l ->
      ...
      method html_of_class_type_kind b father ?ct kind =
        match kind with
        | Class_type cta ->
          begin match cta.cta_type_parameters with
          | [] -> ()
          | l ->
            self#html_of_class_type_param_expr_list b father l;
            bs b " "
      ...
      method html_of_class b ?(complete=true) ?(with_link=true) c =
        ...
        begin match c.cl_type_parameters with
        | [] -> ()
        | l ->
          self#html_of_class_type_param_expr_list b father l;
          bs b " "
      ...
      method html_of_class_type b ?(complete=true) ?(with_link=true) ct =
        ...
        begin match ct.clt_type_parameters with
        | [] -> ()
        | l ->
          self#html_of_class_type_param_expr_list b father l;
          bs b " "
      ...
      =
        ...
        ->
          try
            ...
            in
            let groups =
              Odoc_info.create_index_lists sorted_elements
                (fun e -> Name.simple (name e))
            in
            let f_ele e =
              ...
              then
                ...
                (bp b "<tr><td><a href=\"%s\">%s</a> " (target e)
                 ...
                 (if simple_name <> father_name && father_name <> "" then
                    bp b "[<a href=\"%s\">%s</a>]"
                      (fst (Naming.html_files father_name)) father_name);
                 bs b "</td>\n<td>";
      ...
      method generate_for_class pre post cl =
        ...
        try
          let chanout = open_out (Filename.concat !Global.target_dir html_file)
          in
          let b = new_buf () in
          ...
          bs b doctype;
          bs b "<html>\n";
          self#print_header b ~nav:(Some (pre_name, post_name, cl.cl_name))
            ~comments:(Class.class_comments cl) (self#inner_title cl.cl_name);
          bs b "<body>\n";
          ...
          self#output_class_type cl.cl_name
            (Filename.concat !Global.target_dir type_file) cl.cl_type
        with
        | Sys_error s -> raise (Failure s)
      ...
      method generate_for_class_type pre post clt =
        ...
        try
          ...
          bs b doctype;
          bs b "<html>\n";
          self#print_header b ~nav:(Some (pre_name, post_name, clt.clt_name))
          ...
          self#output_class_type clt.clt_name
            (Filename.concat !Global.target_dir type_file) clt.clt_type
        with
        | Sys_error s -> raise (Failure s)
      ...
      method generate_for_module_type pre post mt =
        try
          ...
          bs b doctype;
          bs b "<html>\n";
          self#print_header b ~nav:(Some (pre_name, post_name, mt.mt_name))
          ...
          bs b "<hr width=\"100%\">\n";
          (* module elements *)
          List.iter (self#html_of_module_element b mt.mt_name)
      ...
      method generate_for_module pre post modu =
        try
          ...
          bs b doctype;
          bs b "<html>\n";
          self#print_header b ~nav:(Some (pre_name, post_name, modu.m_name))
          ...
          (* module elements *)
          List.iter (self#html_of_module_element b modu.m_name)
          ...
          self#output_module_type modu.m_name
            (Filename.concat !Global.target_dir type_file) modu.m_type;
          match modu.m_code with
          | None -> ()
          | Some code ->
            self#output_code ~with_pre:false modu.m_name
              (Filename.concat !Global.target_dir code_file) code
        with
        | Sys_error s -> raise (Failure s)
      ...
      method generate_index module_list =
        try
          let chanout = open_out (Filename.concat !Global.target_dir self#index)
          in
          let b = new_buf () in
          bs b doctype;
          bs b "<html>\n";
          ...
          let info =
            Odoc_info.apply_opt (Odoc_info.info_of_comment_file module_list)
      ...
      method generate_values_index _module_list =
        self#generate_elements_index self#list_values (fun v -> v.val_name)
          (fun v -> v.val_info) Naming.complete_value_target
          Odoc_messages.index_of_values self#index_values
      ...
      method generate_exceptions_index _module_list =
        self#generate_elements_index self#list_exceptions (fun e -> e.ex_name)
          (fun e -> e.ex_info) Naming.complete_exception_target
          Odoc_messages.index_of_exceptions self#index_exceptions
      (** Generate the exceptions index in the file [index_exceptions.html]. *)
      
      method generate_types_index _module_list =
        self#generate_elements_index self#list_types (fun t -> t.ty_name)
          (fun t -> t.ty_info) Naming.complete_type_target
          Odoc_messages.index_of_types self#index_types
      ...
      method generate_attributes_index _module_list =
        self#generate_elements_index self#list_attributes
          (fun a -> a.att_value.val_name) (fun a -> a.att_value.val_info)
      ...
      method generate_methods_index _module_list =
        self#generate_elements_index self#list_methods
          (fun m -> m.met_value.val_name) (fun m -> m.met_value.val_info)
      ...
      method generate_classes_index _module_list =
        self#generate_elements_index self#list_classes (fun c -> c.cl_name)
          (fun c -> c.cl_info) (fun c -> fst (Naming.html_files c.cl_name))
      ...
      method generate_class_types_index _module_list =
        self#generate_elements_index self#list_class_types
          (fun ct -> ct.clt_name) (fun ct -> ct.clt_info)
      ...
      method generate_module_types_index _module_list =
        self#generate_elements_index self#list_module_types
          (fun mt -> mt.mt_name) (fun mt -> mt.mt_info)
      ...
      method generate module_list =
        ...
        known_types_names
        <-
        List.fold_left (fun acc t -> String.Set.add t.ty_name acc)
        ...
        known_classes_names
        <-
        List.fold_left (fun acc c -> String.Set.add c.cl_name acc)
          known_classes_names classes;
        known_classes_names
        <-
        List.fold_left (fun acc ct -> String.Set.add ct.clt_name acc)
        ...
        known_modules_names
        <-
        List.fold_left (fun acc m -> String.Set.add m.m_name acc)
          known_modules_names modules;
        known_modules_names
        <-
        List.fold_left (fun acc mt -> String.Set.add mt.mt_name acc)
