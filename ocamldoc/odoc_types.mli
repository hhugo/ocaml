...
type info =
  {
    ...
    (** The textual description of the \@deprecated tag. *)
...
val dummy_info : info (** An empty info structure. *)
...
type magic (** Type of magic numbers. *)


val magic : magic
(** The magic number for the dumps of this version of ocamldoc. *)

type 'a dump (** A dump of a structure. *)


val make_dump : 'a -> 'a dump (** Create a dump structure. *)
