...
let rec module_all_classes ?(trans=true) m =
  List.fold_left (fun acc m -> acc @ module_all_classes ~trans m)
    (List.fold_left (fun acc mtyp -> acc @ module_type_all_classes ~trans mtyp)
       (module_classes ~trans m) (module_module_types ~trans m))
...
and module_type_all_classes ?(trans=true) mt =
  List.fold_left (fun acc m -> acc @ module_all_classes ~trans m)
    (List.fold_left (fun acc mtyp -> acc @ module_type_all_classes ~trans mtyp)
       (module_type_classes ~trans mt) (module_type_module_types ~trans mt))
