...
type menu_data =
  [ subparts | `Blank | `Comment of string | `Texi of string | `Index of string ]
  list
    ...
    if subpart_list <> [] then (
      let menu_line part_qual name =
        ...
        if sname = name then (
          ...
          puts chan (pad_to 35 ("* " ^ sname ^ ": " ^ fix_nodename name ^ ". "));
          puts_nl chan part_qual)
      in
      puts_nl chan "@menu";
      List.iter
    ...
    object (self)
      ...
      method private soft_fix_linebreaks =
        ...
        fun ind t ->
          let rep = "\n" ^ String.make ind ' ' in
          List.map
            (function Raw s -> Raw (Str.global_replace re rep s) | txt -> txt)
            t
      ...
      method texi_of_attribute a =
        ...
        let t =
          [
            ...
            self#index `Class_att a.att_value.val_name;
            Newline;
          ]
      ...
      method texi_of_method m =
        ...
        let t =
          [
            ...
            self#index `Method m.met_value.val_name;
            Newline;
          ]
      ...
      method string_of_type_args (args : constructor_args)
          (ret : Types.type_expr option) =
        let f = function
                  ...
                  :: List.flatten
                       (List.map
                          (fun r ->
                            ...
                            @ [ Raw " ;" ] @ entry_doc r.rf_text)
                          l)
                  @ [ Raw " }" ]
              | Type_open -> [ Raw " = .."; Newline ]);
            self#index `Type ty.ty_name;
            Newline;
          ]
      ...
      method texi_of_exception e =
        ...
        let t =
          [
            ...
            self#index `Exception e.ex_name;
            Newline;
          ]
      ...
      method texi_of_module m =
        ...
        let t =
          [
            ...
            (if is_alias m then [ self#index `Module m.m_name; Newline ]
            else [ Newline ]);
      ...
      method texi_of_module_type mt =
        ...
        let t =
          [
            ...
            (if is_alias mt then [ self#index `Module_type mt.mt_name; Newline ]
            else [ Newline ]);
      ...
      method texi_of_class c =
        ...
        let t =
          [
            ...
            Ref (c.cl_name, Some RK_class, None);
            Newline;
            Newline;
          ]
      ...
      method texi_of_class_type ct =
        ...
        let t =
          [
            ...
            Ref (ct.clt_name, Some RK_class_type, None);
            Newline;
            Newline;
          ]
        ...
        try
          ...
          let title =
            [
              ...
              self#index `Module_type mt.mt_name;
              Newline;
            ]
          in
          puts chanout (self#texi_of_text title);
          ...
          List.iter
            (fun ele ->
              puts chanout (self#texi_of_module_element mt.mt_name ele))
            mt_ele;
      ...
      method generate_texi_header chan texi_filename m_list =
        let title =
          match !Global.title with None -> "" | Some s -> self#escape s
        in
        let filename =
        ...
        List.iter (puts_nl chan)
          (List.flatten
             [
               ...
               (if !Global.with_index then
                List.map
                  (fun ind -> "@defcodeindex " ^ indices ind)
                  indices_to_build
               else []);
               [ Texi.dirsection !info_section ];
               Texi.direntry
                 (if !info_entry <> [] then !info_entry
                 else
                   [
      ...
      method generate module_list =
        ...
        try
          let chanout =
            open_out (Filename.concat !Global.target_dir filename)
          in
