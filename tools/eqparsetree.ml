...
module Asttypes = struct
  ...
  let eq_direction_flag : (direction_flag * direction_flag) -> 'result =
    function
    | Upto, Upto -> true
    | Downto, Downto -> true
    | _, _ -> false
...
and eq_core_field_desc : (core_field_desc * core_field_desc) -> 'result =
  function
...
and eq_core_type_desc : (core_type_desc * core_type_desc) -> 'result =
  function
...
=
  fun
    mf_a
    ({ pci_virt = a0; pci_params = a1; pci_name = a2; pci_expr = a3;
       pci_variance = a4; pci_loc = a5 },
     { pci_virt = b0; pci_params = b1; pci_name = b2; pci_expr = b3;
       pci_variance = b4; pci_loc = b5 })
  ->
    ((((Asttypes.eq_virtual_flag (a0, b0) &&
          (fun ((a0, a1), (b0, b1)) ->
               eq_list (Asttypes.eq_loc eq_string) (a0, b0) &&
                 Location.eq_t (a1, b1)) (a1, b1)) &&
...
=
  ...
  | Pstr_value (a0, a1), Pstr_value (b0, b1) ->
    Asttypes.eq_rec_flag (a0, b0) &&
      eq_list
        (fun ((a0, a1), (b0, b1)) ->
           eq_pattern (a0, b0) && eq_expression (a1, b1)) (a1, b1)
...
and eq_with_constraint : (with_constraint * with_constraint) -> 'result =
  function
...
=
  ...
  | Psig_recmodule a0, Psig_recmodule b0 ->
    eq_list
      (fun ((a0, a1), (b0, b1)) ->
         Asttypes.eq_loc eq_string (a0, b0) && eq_module_type (a1, b1)) (a0, b0)
  ...
  | Pmty_with (a0, a1), Pmty_with (b0, b1) ->
    eq_module_type (a0, b0) &&
      eq_list
        (fun ((a0, a1), (b0, b1)) ->
           Asttypes.eq_loc Longident.eq_t (a0, b0) &&
             eq_with_constraint (a1, b1)) (a1, b1)
...
and eq_class_field_desc : (class_field_desc * class_field_desc) -> 'result =
  ...
  | Pcf_constr a0, Pcf_constr b0 ->
    (fun ((a0, a1), (b0, b1)) -> eq_core_type (a0, b0) && eq_core_type (a1, b1))
      (a0, b0)
...
and eq_class_expr_desc : (class_expr_desc * class_expr_desc) -> 'result =
  function
  ...
  | Pcl_apply (a0, a1), Pcl_apply (b0, b1) ->
    eq_class_expr (a0, b0) &&
      eq_list
        (fun ((a0, a1), (b0, b1)) ->
           Asttypes.eq_label (a0, b0) && eq_expression (a1, b1)) (a1, b1)
...
and eq_class_type_desc : (class_type_desc * class_type_desc) -> 'result =
  function
...
and eq_type_declaration : (type_declaration * type_declaration) -> 'result =
  fun
    ({ ptype_params = a0; ptype_cstrs = a1; ptype_kind = a2; ptype_private = a3;
       ptype_manifest = a4; ptype_variance = a5; ptype_loc = a6 },
     { ptype_params = b0; ptype_cstrs = b1; ptype_kind = b2; ptype_private = b3;
       ptype_manifest = b4; ptype_variance = b5; ptype_loc = b6 })
  ->
    (((((eq_list (eq_option (Asttypes.eq_loc eq_string)) (a0, b0) &&
           eq_list
             (fun ((a0, a1, a2), (b0, b1, b2)) ->
                (eq_core_type (a0, b0) && eq_core_type (a1, b1)) &&
                  Location.eq_t (a2, b2)) (a1, b1)) &&
          eq_type_kind (a2, b2)) &&
...
and eq_expression_desc : (expression_desc * expression_desc) -> 'result =
  function
  ...
  | Pexp_fun (a1, a1, a2, a3), Pexp_function (b0, b1, b2, b3) ->
    Asttypes.eq_label (a0, b0) &&
      eq_option eq_expression (a1, b1) &&
        eq_pattern a2 b2 && eq_expression (a3, b3)
  | Pexp_function (a0, a1, a2), Pexp_function (b0, b1, b2) ->
    (* FIX *)
    eq_list
      (fun ((a0, a1), (b0, b1)) -> eq_pattern (a0, b0) && eq_expression (a1, b1))
      (a2, b2)
  ...
  | Pexp_override a0, Pexp_override b0 ->
    eq_list
      (fun ((a0, a1), (b0, b1)) ->
         Asttypes.eq_loc eq_string (a0, b0) && eq_expression (a1, b1)) (a0, b0)
...
and eq_toplevel_phrase : (toplevel_phrase * toplevel_phrase) -> 'result =
  function
